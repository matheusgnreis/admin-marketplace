<template>
  <div class="container py-4">
    <a-row>
      <a-col :sm="5">
        <h4 class="py-4">{{i19yourInstalledApps}}</h4>
        <ec-app-list :apps="installedApplications"></ec-app-list>
      </a-col>
      <a-col>
        <a-row type="flex">
          <a-col :span="24">
            <h4 class="py-4 ml-30">{{i19availableApps}}</h4>
          </a-col>
          <a-col :span="24">
            <a-row type="flex" justify="space-between" class="mb-4">
              <a-col :span="15" :offset="1">
                <a-dropdown>
                  <a-menu slot="overlay">
                    <a-menu-item>
                      <router-link to="/apps/">{{i19allCategories}}</router-link>
                    </a-menu-item>
              ...
              <a-col :span="8">
                <a-input-search :placeholder="i19search" v-model="searchField" @search="loadApplications()" />
              </a-col>
            </a-row>
            <a-row type="flex">
